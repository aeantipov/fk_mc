...
int main()
{
    ...
    FKDEBUG(l1.pos_to_index({0,0}));
    FKDEBUG(l1.pos_to_index({0,2}));
    FKDEBUG(l1.pos_to_index({1,0}));
    FKDEBUG(l1.pos_to_index({2,1}));

    FKDEBUG(l1.index_to_pos(0));
    FKDEBUG(l1.index_to_pos(2));
    FKDEBUG(l1.index_to_pos(4));
    FKDEBUG(l1.index_to_pos(9));
    ...
    catch (std::exception &e){FKDEBUG(e.what());};
    INFO(l1.hopping_m);
